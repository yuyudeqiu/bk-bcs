...
可以参考 swagger
文档查看相关接口以及参数等信息：[clustermanager.swagger.json](https://github.com/TencentBlueKing/bk-bcs/blob/master/bcs-services/bcs-cluster-manager/api/clustermanager/clustermanager.swagger.json)
