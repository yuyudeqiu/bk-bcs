...
replace (
	github.com/TencentBlueKing/iam-go-sdk => code.cwoa.net/rd-fy22-canway-platform-products/iam-go-sdk v0.1.5-alpha.0-xc.4
...
require (
	code.cwoa.net/carlchen2/cw-godb-sdk v0.4.8
