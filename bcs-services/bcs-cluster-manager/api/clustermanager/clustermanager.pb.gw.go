...
func request_ClusterManager_ReimportCluster_0(ctx context.Context, marshaler runtime.Marshaler, client ClusterManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReimportClusterReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ReimportCluster(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ClusterManager_ReimportCluster_0(ctx context.Context, marshaler runtime.Marshaler, server ClusterManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReimportClusterReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ReimportCluster(ctx, &protoReq)
	return msg, metadata, err

}

func request_ClusterManager_ReimportClusterValidate_0(ctx context.Context, marshaler runtime.Marshaler, client ClusterManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReimportClusterValidateReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ReimportClusterValidate(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ClusterManager_ReimportClusterValidate_0(ctx context.Context, marshaler runtime.Marshaler, server ClusterManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReimportClusterValidateReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ReimportClusterValidate(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterClusterManagerGwServer(ctx context.Context, mux *runtime.ServeMux, server ClusterManagerServer) error {
	...
	mux.Handle("POST", pattern_ClusterManager_ReimportCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_ClusterManager_ReimportCluster_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ClusterManager_ReimportCluster_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_ClusterManager_ReimportClusterValidate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_ClusterManager_ReimportClusterValidate_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ClusterManager_ReimportClusterValidate_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterClusterManagerGwClient(ctx context.Context, mux *runtime.ServeMux, client ClusterManagerClient) error {
	...
	mux.Handle("POST", pattern_ClusterManager_ReimportCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ClusterManager_ReimportCluster_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ClusterManager_ReimportClusterValidate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ClusterManager_ReimportClusterValidate_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ClusterManager_ReimportCluster_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"clustermanager", "v1", "cluster", "reimport"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ClusterManager_ReimportClusterValidate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"clustermanager", "v1", "cluster", "reimport", "validate"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_ClusterManager_GetBatchCustomSetting_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6, 1, 0, 4, 1, 5, 7, 1, 0, 4, 1, 5, 8, 2, 9}, []string{"clustermanager", "v1", "web", "customSettings", "projects", "projectID", "scope", "scopeType", "scopeId", "batchGet"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_ClusterManager_ReimportCluster_0 = runtime.ForwardResponseMessage

	forward_ClusterManager_ReimportClusterValidate_0 = runtime.ForwardResponseMessage
